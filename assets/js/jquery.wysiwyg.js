			...
			html: {
				...
				exec: function (preProcessor, postProcessor) {
					...
					if (this.viewHTML) { //textarea is shown
						...
						var cleaned = tidy_html5(html, settings);
						$(this.original).val(cleaned);

						$(this.original).css("cssText",
							"width: " + this.editor.width() + "px; height: " + this.editor.height() + "px; resize: none; opacity: 1; font-size: 13px; line-height: 150%; padding: 10px; font-family: Consolas,Monaco,monospace !important;"
						).show();
						this.editor.hide();
